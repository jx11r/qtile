...
widgets = lambda: [
    ...
    sep(palette.grey, offset=-14),
    groups(None),
    sep(palette.grey, offset=8, padding=2),
    *volume(palette.purple, palette.base),
    ...
    *disk(palette.aqua, palette.base),
    sep(palette.grey),
    *clock(palette.purple, palette.base),
    widget.Spacer(length=1),
]
